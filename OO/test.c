...
int testBuscarDeclararMiembroClase() {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "AA", "sa1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (AA_sA1) NO ESTÁ EN AA (SOLO SE BUSCA EN AA) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "AA", "sa1", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 49 OK\nBuscar: OK (AA_sA1) YA ESTÁ EN %s (SOLO SE BUSCA EN AA) NO SE PUEDE DECLARAR\n\n", nombre_ambito_encontrado);
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "AA", "ha1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (AA_hA1) NO ESTÁ EN AA (SOLO SE BUSCA EN AA) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "AA", "xa1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (AA_xA1) NO ESTÁ EN AA (SOLO SE BUSCA EN AA) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "AA", "MA1@1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (AA_MA1@1) NO ESTÁ EN AA (SOLO SE BUSCA EN AA) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "AA", "MA1@1", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 49 OK\nBuscar: OK (AA_MA1@1) YA ESTÁ EN %s (SOLO SE BUSCA EN AA) NO SE PUEDE DECLARAR\n\n", nombre_ambito_encontrado);
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "AA", "MA1@1@1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (AA_MA1@1@1) NO ESTÁ EN AA (SOLO SE BUSCA EN AA) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "BB", "sa1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (BB_sA1) NO ESTÁ EN BB (SOLO SE BUSCA EN BB) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "BB", "ha1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (BB_hA1) NO ESTÁ EN BB (SOLO SE BUSCA EN BB) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "BB", "xa1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (BB_xA1) NO ESTÁ EN BB (SOLO SE BUSCA EN BB) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "BB", "MB1@1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (BB_MB1@1) NO ESTÁ EN BB (SOLO SE BUSCA EN BB) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "BB", "MA1@1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (BB_MA1@1) NO ESTÁ EN BB (SOLO SE BUSCA EN BB) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroClase(ej_tabla_clases, "BB", "MA2@1@1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 50 OK\nBuscar: ERROR (BB_MA2@1@1) NO ESTÁ EN BB (SOLO SE BUSCA EN BB) SE PUEDE DECLARAR\n\n");
    } else {
...
int testBuscarDeclararMiembroInstancia() {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "AA", "sa1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 53 OK\nBuscar: ERROR (AA_sA1) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "AA", "sa1", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 51 OK\nBuscar: OK (AA_sA1) YA ESTÁ EN %s NO SE PUEDE DECLARAR\n\n", nombre_ambito_encontrado);
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "AA", "ha1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 53 OK\nBuscar: ERROR (AA_hA1) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "AA", "mA1@1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 53 OK\nBuscar: ERROR (AA_mA1@1) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "AA", "mA1@1", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 51 OK\nBuscar: OK (AA_mA1@1) YA ESTÁ EN %s NO SE PUEDE DECLARAR\n\n", nombre_ambito_encontrado);
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "AA", "mA1@1@3", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 53 OK\nBuscar: ERROR (AA_mA1@1@3) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "AA", "mA2", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 53 OK\nBuscar: ERROR (AA_mA2) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "AA", "mA3@1@3", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 53 OK\nBuscar: ERROR (AA_mA3@1@3) SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "BB", "ha1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 52 OK\nBuscar: ERROR (BB_ha1) EXISTE AA_ha1 (EN %s) PERO NO ES ACCESIBLE PORQUE ES HIDDEN SE PUEDE DECLARAR\n\n", nombre_ambito_encontrado);
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "BB", "hb1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 52 OK\nBuscar: ERROR (BB_hb1) NO EXISTE, SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "BB", "xa1", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 52 OK\nBuscar: OK (AA_sA1) DECLARADO EN %s ES ATRIBUTO DE INSTANCIA ACCESIBLE CON ACCESO exposed NO SE PUEDE DECLARAR\n\n", nombre_ambito_encontrado);
    } else {
        printf("Caso 52 FALLIDO Buscar: AA_sA1 NO ENCONTRADO EN AA\n\n");
    }
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "BB", "mA1@1", &e, nombre_ambito_encontrado) == OK) {
        if(e->tipo_miembro == MIEMBRO_NO_UNICO) {
            printf("Caso 52 OK\nBuscar: OK (AA_mA1@1) EXISTE EN LA JERARQUIA (%s) ES ACCESIBLE (SECRET) Y ES SOBREESCRIBIBLE: SE ESTÁ SOBREESCRIBIENDO\n\n", nombre_ambito_encontrado);
        } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "BB", "mB1@1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 53 OK\nBuscar: ERROR (BB_mB1) NO EXISTE EN NINGÚN LUGAR SE PUEDE DECLARAR\n\n");
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "BB", "mA2", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 52 OK\nBuscar: ERROR (AA_mA2) mA2 EXISTE EN %s PERO NO ES ACCESIBLE (HIDDEN) SE PUEDE DECLARAR\n\n", nombre_ambito_encontrado);
    } else {
    ...
    if(buscarParaDeclararMiembroInstancia(ej_tabla_clases, "BB", "mA3@3@1", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 52 OK\nBuscar: ERROR (BB_mA3@3@1) NO EXISTE EN NINGÚN LUGAR SE PUEDE DECLARAR\n\n");
    } else {
...
int testBuscarUso() {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "miaa", "inspriv", "AA", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 48: OK\nSE ACCEDE DESDE UN MÉTODO A UN ATRIBUTO (inspriv) QUE EXISTE EN LA JERARQUÍA (AA) Y ESTÁ ACCESIBLE (inspriv es hidden pero estamos en AA) A TRAVÉS DE UNA INSTANCIA QUE SÍ ESTÁ ACCESIBLE (miaa)\n\n");
    } else {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "miaa", "insprot", "AA", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 47.3: OK\nSE ACCEDE DESDE UN MÉTODO A UN ATRIBUTO (insprot) QUE EXISTE EN LA JERARQUÍA Y ESTÁ ACCESIBLE (insprot es secret) CUALIFICANDO POR UNA INSTANCIA ACCESIBLE (miaa)\n\n");
    } else {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "miaa", "inspub", "AA", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 47.3: OK\nSE ACCEDE DESDE UN MÉTODO A UN ATRIBUTO (inspub) QUE EXISTE EN LA JERARQUÍA Y ESTÁ ACCESIBLE (inspub es exposed) CUALIFICANDO POR UNA INSTANCIA ACCESIBLE (miaa)\n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "AA", "claseprot", "AA", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 35: OK\nSE BUSCA DESDE UN MÉTODO ALGO DE UNA CLASE (AA) QUE ESTÁ EN LA JERARQUÍA Y ES ACCESIBLE (claseprot es secret y estamos en la clase)\n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "AA", "clasepub", "AA", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 35: OK\nSE BUSCA DESDE UN MÉTODO ALGO DE UNA CLASE (AA) QUE ESTÁ EN LA JERARQUÍA Y ES ACCESIBLE (clasepub es exposed)\n\n");
    } else {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "MainMiBB", "insnoexiste", "main", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 40.1: OK\nSE BUSCA ALGO QUE NO EXISTE CUALIFICADO POR UNA INSTANCIA QUE EXISTE Y ES GLOBAL\n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "EE", "claseNoExiste", "EE", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 37: OK\nDESDE DENTRO DE UN MÉTODO, SE ACCEDE A ALGO CUALIFICADO POR UNA CLASE (EE) QUE EXISTE PERO LO BUSCADO NO EXISTE (claseNoExiste)\n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "noExiste", "claseNoExiste", "EE", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 38: OK\nDESDE DENTRO DE UN MÉTODO, SE ACCEDE A ALGO CUALIFICADO POR UNA CLASE (noExiste) QUE NO EXISTE\n\n");
    } else {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "MainMiBB2", "inspub", "EE", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 46.3: OK\nDESDE DENTRO DE UN MÉTODO, SE BUSCA ALGO CUALIFICADO POR UNA INSTANCIA DE UNA CLASE (B) QUE ES UNA VARIABLE GLOBAL Y LO BUSCADO ES UN ATRIBUTO (inspub) QUE NO ESTÁ EN LA CLASE PERO SÍ EN LA JERARQUÍA (en A) Y ES ACCESIBLE (exposed)\n\n");
    } else {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "miee", "insNoExiste", "EE", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 47.1: OK\nDESDE UN MÉTODO SE ACCEDE A ALGO CUALIFICADO POR UNA INSTANCIA (miee) QUE ES UN ATRIBUTO ACCESIBLE EN ESTE CASO DE LA MISMA CLASE PERO EL ATRIBUTO BUSCADO (insNoExiste) NO EXISTE\n\n");
    } else {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "varLoc", "inspub", "EE", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 45.3: OK\nDESDE UN METODO SE ACCEDE A ALGO CUALIFICADO POR UNA INSTANCIA (varLoc) QUE ES UNA VARIABLE LOCAL DEL MÉTODO DE UN CLASE QUE EXISTE (E) Y LA COSA BUSCADA (inspub) ES UNA ATRIBUTO QUE AUNQUE NO ESTÁ EN LA CLASE SÍ ESTÁ EN  LA JERARQUÍA (A) Y ES ACCESIBLE (exposed)\n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "AA", "clasepriv", "main", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 32: OK\nACCESOS DESDE UNA FUNCIÓN GLOBAL (prueba) A ALGO CUALIFICADO POR UNA CLASE (A) QUE EXISTE Y LO BUSCADO (clasepriv) ES ATRIBUTO DE ESA CLASE SON DE CLASE Y NO ES ACCESIBLE \n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "AA", "clasepub", "main", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 31: OK\nACCESOS DESDE UNA FUNCIÓN GLOBAL (prueba) A ALGO CUALIFICADO POR UNA CLASE (A) QUE EXISTE Y LO BUSCADO (clasepub) ES ATRIBUTO DE ESA CLASE SON DE CLASE Y ES ACCESIBLE \n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "AA", "claseNoExiste", "main", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 33: OK\nACCESOS DESDE UNA FUNCIÓN GLOBAL (prueba) A ALGO CUALIFICADO POR UNA CLASE (A) QUE EXISTE Y LO BUSCADO (claseNoExiste) NO \n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "noExiste", "claseNoExiste", "main", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 34: OK\nACCESO DESDE FUNCIÓN GLOBAL DE ALGO CUALIFICADO POR UNA CLASE QUE NO EXISTE \n\n");
    } else {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "MainMiBB2", "insNoExiste", "main", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 43.1: OK\nACCESO DESDE UNA FUNCIÓN GLOBAL (prueba) DE UN ID (insNoExiste) CUALIFICADO POR UNA INSTANCIA (MainMiBB2) QUE EXISTE COMO VARIABLE GLOBAL DE UNA CLASE (B) QUE NO TIENE ESE ATRIBUTO DE NINGUNA MANERA\n\n");
    } else {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "MainMiBB2", "inspub", "main", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 42.3: OK\nACCESO DESDE UNA FUNCIÓN GLOBAL (f2) DE UN ID (inspub) CUALIFICADO POR UNA INSTANCIA (MainMiBB2) QUE EXISTE COMO VARIABLE GLOBAL DE UNA CLASE (B) QUE NO TIENE ESOS ATRIBUTOS PERO QUE SÍ LOS TIENE SU JERARQUIA (A) Y ADEMÁS DESDE ELLA (B) ES ACCESIBLE (exposed)\n\n");
    } else {
    ...
    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "MainMiBB2", "inspriv", "main", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 43.3: OK\nACCESO DESDE UNA FUNCIÓN GLOBAL (f2) DE UN ID (inspub y inspriv) CUALIFICADO POR UNA INSTANCIA (MainMiBB2) QUE EXISTE COMO VARIABLE GLOBAL DE UNA CLASE (B) QUE NO TIENE ESOS ATRIBUTOS PERO QUE SÍ LOS TIENE SU JERARQUIA (A) Y ADEMÁS DESDE ELLA (B) NO ES ACCESIBLE (hidden)\n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "JJ", "noExiste", "main", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 30: OK\nDESDE EL CÓDIGO DE MAIN SE BUSCA ALGO CUALIFICADO POR UNA CLASE QUE NO EXISTE (JJ) \n\n");
    } else {
        printf("Caso 30 FALLIDO Buscar: JJ ENCONTRADO CUANDO NO DEBERIA\n\n");
    }

    if(buscarIdCualificadoInstancia(ej_tabla_clases, tabla_main, "MainMiBB2", "inspub", "main", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 40.3: OK\nESDE EL CÓDIGO DE MAIN SE BUSCA ALGO CUALIFICADO POR UNA INSTANCIA (MainMiBB2) QUE EXISTE COMO VARIABLE GLOBAL DE UNA CLASE (B) QUE NO TIENE ESOS ATRIBUTOS PERO QUE SÍ LOS TIENE SU JERARQUIA (A) Y ADEMÁS DESDE ELLA (B) ES ACCESIBLE (exposed)\n\n");
    } else {
        printf("Caso 40.3 FALLIDO Buscar: MainMiBB2.inspub NO ACCESIBLE CUANDO DEBERIA\n\n");
    }

    if(buscarIdCualificadoClase(ej_tabla_clases, "AA", "clasepub", "main", &e, nombre_ambito_encontrado) == OK) {
        printf("Caso 27.1: OK\nDESDE EL CÓDIGO DE MAIN SE BUSCA ALGO CUALIFICADO POR UNA CLASE QUE EXISTE (AA) Y EL ID BUSCADO (clasepub) ES UN ATRIBUTO QUE EXISTE EN LA CLASE, ACCESIBLE Y ATRIBUTO DE CLASE\n\n");
    } else {
        printf("Caso 27.1 FALLIDO Buscar: AA.clasepub NO ACCESIBLE CUANDO DEBERIA\n\n");
    }

    if(buscarIdCualificadoClase(ej_tabla_clases, "AA", "clasepriv", "main", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 28: OK\nDESDE EL CÓDIGO DE MAIN SE BUSCA ALGO CUALIFICADO POR UNA CLASE QUE EXISTE (AA) Y EL ID BUSCADO (clasepriv) ES UN ATRIBUTO QUE EXISTE EN LA CLASE, NO ACCESIBLE (hidden)\n\n");
    } else {
    ...
    if(buscarIdCualificadoClase(ej_tabla_clases, "AA", "claseNoExiste", "noExiste", &e, nombre_ambito_encontrado) == ERR) {
        printf("Caso 29: OK\nDESDE EL CÓDIGO DE MAIN SE BUSCA ALGO CUALIFICADO POR UNA CLASE QUE EXISTE (AA) Y EL ID BUSCADO (noExiste) NO EXISTE\n\n");
    } else {
